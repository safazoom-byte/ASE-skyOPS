    ...
    try {
      ...
      if (authError) {
        if (authError.message.includes("Signups not allowed")) {
          throw new Error(
            "Signups are currently disabled in your Supabase dashboard. Please go to Authentication -> Providers -> Email and enable 'Enable Email Signup'.",
          );
        }
        throw authError;
      }
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            ...
            >
              {loading ? (
                ...
                <>
                  {" "}
                  {isLogin ? "Initialize Uplink" : "Register Terminal"}{" "}
